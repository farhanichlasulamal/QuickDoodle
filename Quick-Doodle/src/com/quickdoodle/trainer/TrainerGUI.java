...
public class TrainerGUI extends JFrame {
	...
	public TrainerGUI() {
		...
		try {
			objectList = DBHandler.loadObjects("./data/dev/obj_list.txt");
		} catch (Exception e) {
			try {
				DBHandler.downloadFileDev("obj_list.txt");
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (stringName.isEmpty()) {
					...
					try {
						...
						String dataSet = trainer.initializeDataset(objectList, Integer.parseInt(stringBatch),
								Float.parseFloat(stringRatio));
